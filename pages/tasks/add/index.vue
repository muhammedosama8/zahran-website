        ...
        <div class="col-12">
          <div class="card p-4">
            ...
            <div class="newQuestions">
              <div class="firstQ" v-for="(question,index) in questions" :key="randomKey+index">
                <h6 class="py-3 questionH">Question {{ index + 1 }}
                  <button class="btn bg-white border-0 pt-0 mt-0 text-danger font-weight-bold float-right"
                          @click="removeQuestion(index)">Remove
                  </button>
                </h6>
                ...
                <div class="row newTask" v-if="question.showAnswerValues">
                  <div class="col-md-3 pb-2" v-for="i in 4" :key="randomKey+i">
                    <div>
                      <FormulateInput
                        v-model="question.answer_values[i]"
                        type="text"
                        :label="'Answer '+i "
                        validation="bail"
                      />
            ...
            <div class="col-md-6">
              <client-only>
                <FormulateInput
                  ...
                  validation="bail|required"
                  label="Branch/es *"
                  :customplaceholder="'Select branches'"
                  :isMultiple="true"
