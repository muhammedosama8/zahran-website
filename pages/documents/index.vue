    ...
    <div class="col-12">
      <div class="row py-2 widthFilter">
        ...
        <div class="col-lg-8 col-sm-12 col-md-8 text-md-right">
          <b-button
            v-if="hasPermission('documents.add')"
            tag="nuxt-link"
            :to="{ name: 'documents-add' }"
            variant="primary"
            class="mb-3 btnAdd"
          ><img src="~/assets/images/add.svg" alt class="img-fluid" />
            Add New Document
          </b-button>
        </div>
        <!-- End search -->
        ...
        <div class="col-xl-8 col-md-6 pt-2">
          <div
            ...
            class="dataTables_length text-md-right float-right"
          >
      ...
      <div class="table-responsive-lg bg-white mb-3">
        <b-table
          ...
          responsive="lg"
          :per-page="0"
          empty-text="No Matching Document created"
          :show-empty="true"
        >
          <template v-if="hasPermission('documents.show') || hasPermission('documents.delete')" v-slot:cell(actions)="data">
            <b-dropdown
            ...
            >
              ...
              <b-dropdown-item
                ...
                :to="{
                  ...
                  params: { documentId: data.item.id }
                }"
              >
      ...
      >
        <p class="text-center py-2">
          Kindly note that this action can't be undone and this document
