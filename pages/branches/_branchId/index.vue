  ...
  <div class="container-fluid">
          ...
          <div class="card-body pb-5">
            ...
            <client-only v-if="!$fetchState.pending">
              ...
              <b-row v-show="!showMap">
                ...
                <lazy-map-select ref="mapSelect" v-show="showMap" :pinLocation="{lat: branchFormValue.lat, lng: branchFormValue.lng}"/>
                <br>
                <div class="row">
                <div class="col-md-4 pt-4">
                  <!-- eslint-disable -->
    ...
    <div class="d-flex w-100 justify-content-between pt-4">
      ...
      <div class="d-flex align-items-center">
        <button class="btn btnSave px-4" type="submit" @click="updateBranch">
          Save
        </button>
      </div>
    </div>
