  ...
  <div class="container-fluid">
        ...
        <div class="card">
          <div class="card-body">
            ...
            >
              ...
              <FormulateInput
                  custom-help="Decide to activate or deactivete this brand"
                  custom-label="Status"
                  name="status"
                  type="switchInput"
                  value="true"
    ...
    <div class="d-flex w-100 justify-content-between pt-4">
      ...
      <div class="d-flex align-items-center">
        <button class="btn btnSave px-4" type="submit" @click="addNewBrand">
          Save
        </button>
      </div>
    </div>
