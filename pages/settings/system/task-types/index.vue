<template>
  <div class="row">
    <div class="col-12">
      <div class="row py-2 justify-content-between">
        ...
        <div class="col-lg-8 col-sm-12 col-md-8 text-md-right">
          <b-button
            ...
            v-b-modal.createTaskTypeModal
            variant="primary"
            class="mb-2 btnAdd"
            ><i class="fa fa-plus pr-2"></i> Add New Task Type
          </b-button>
        </div>
        <!-- End search -->
      </div>
      ...
      <div class="table-responsive bg-white mb-3">
        <b-table
          ...
          :items="taskTypes"
          responsive="lg"
          empty-text="No matching task types created"
          :show-empty="true"
          class="px-4 pb-2"
        >
          <template
    ...
    <b-modal
      id="createTaskTypeModal"
      ref="createTaskTypeModal"
      centered
      ...
      >
        <div class="d-flex justify-content-between">
          <span
            ...
            @click.prevent="$refs.createTaskTypeModal.hide()"
          >
            Cancel
          </span>
    ...
    <!--  Start Update modal  -->
    <b-modal
      id="updateTaskTypeModal"
      ref="updateTaskTypeModal"
      centered
    ...
    >
      <FormulateForm
        v-model="updateTaskTypeFormValues"
        :schema="taskTypeFormSchema"
        @submit="updateTaskType"
      >
        <div class="d-flex justify-content-between">
          <span
            class="btn btnCancel newBtn"
            @click.prevent="$refs.updateTaskTypeModal.hide()"
          >
            Cancel
          </span>
          <button class="btn btnSave px-3 newBtn" type="submit">
    ...
    <!--  Start Delete modal  -->
    <b-modal
      id="deleteTaskTypeModal"
      ref="deleteTaskTypeModal"
      centered
    ...
    >
      <p class="p-2 text-center">
        Kindly note that this action can't be undone, and deleting this task
        type will make linked tasks to it have no task type.
      </p>
      <div class="d-flex justify-content-between">
        <button
          class="btn btnCancel newBtn"
          @click.prevent="$refs.deleteTaskTypeModal.hide()"
        >
          Cancel
        </button>
        <button
...
<script src="./task_types.js"></script>
