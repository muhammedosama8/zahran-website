  ...
  <div class="row">
    <div class="col-12">
      <div class="row py-2 justify-content-between">
        ...
        <div class="col-lg-8 col-sm-12 col-md-8 text-md-right">
          <b-button
            ...
            v-b-modal.createCityModal
            variant="primary"
            class="mb-2 btnAdd"
          >
            <i class="fa fa-plus pr-2"></i> Add New City
          </b-button>
        </div>
        <!-- End search -->
      </div>
      ...
      <div class="table-responsive bg-white mb-3">
        <b-table
          ...
          responsive="lg"
          :per-page="0"
          empty-text="No matching cities created yet"
          :show-empty="true"
          class="px-4 pb-2"
        >
          <template
    ...
    >
      ...
      <FormulateInput
          ...
          label="Select Region"
          :customplaceholder="'Select Region'"
          :is-loading="regions < 1"
          :options="addCityFormOptions"
        />
        <div class="d-flex justify-content-between">
          <span
            class="btn btnCancel newBtn"
            @click.prevent="$refs.createCityModal.hide()"
            >Cancel</span
          >
    ...
    >
      ...
      <FormulateInput
        ...
        <div class="d-flex justify-content-between">
          <span
            class="btn btnCancel newBtn"
            @click.prevent="$refs.updateCityModal.hide()"
            >Cancel</span
          >
          <button class="btn btnSave px-3 newBtn" type="submit">
            Update City
    ...
    >
      <p class="p-2 text-center">
        Kindly note that this action can't be undone, and deleting this city
        will delete its territories too.
      </p>
      <div class="d-flex justify-content-between">
        <button
          class="btn btnCancel newBtn"
          @click.prevent="$refs.deleteCityModal.hide()"
        >
          Cancel
        </button>
        <button class="btn btn-danger newBtn" type="submit" @click="deleteCity">
          Delete City
        </button>
      </div>
    </b-modal>
